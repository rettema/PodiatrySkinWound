...
[FHIR Version STU3]: {{site.data.fhir.path}}index.html "FHIR Version SUT3 Specification Home Page"
...
[US Core Patient (STU3)]: {{page.us_r3}}StructureDefinition-us-core-patient.html
[US Core Practitioner (STU3)]: {{page.us_r3}}StructureDefinition-us-core-practitioner.html
[US Core Encounter (STU3)]: {{page.us_r3}}StructureDefinition-us-core-encounter.html
[US Core Condition (STU3)]: {{page.us_r3}}StructureDefinition-us-core-condition.html
[FHIR Observation (STU3)]: {{page.r3}}observation.html
[FHIR AuditEvent (STU3)]: {{page.r3}}auditevent.html
